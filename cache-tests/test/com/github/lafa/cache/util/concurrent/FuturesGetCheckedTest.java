...
import static com.github.lafa.cache.util.concurrent.ClassPathUtil.parseJavaClassPath;
import static com.github.lafa.cache.util.concurrent.Futures.getChecked;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.CHECKED_EXCEPTION;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.ERROR;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.ERROR_FUTURE;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.FAILED_FUTURE_CHECKED_EXCEPTION;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.FAILED_FUTURE_ERROR;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.FAILED_FUTURE_OTHER_THROWABLE;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.FAILED_FUTURE_UNCHECKED_EXCEPTION;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.OTHER_THROWABLE;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.RUNTIME_EXCEPTION;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.RUNTIME_EXCEPTION_FUTURE;
import static com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.UNCHECKED_EXCEPTION;
import static com.google.common.truth.Truth.assertThat;
import static com.google.common.util.concurrent.Futures.immediateFuture;
import static java.util.concurrent.TimeUnit.SECONDS;

import com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.ExceptionWithBadConstructor;
import com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.ExceptionWithGoodAndBadConstructor;
import com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.ExceptionWithManyConstructors;
import com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.ExceptionWithPrivateConstructor;
import com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.ExceptionWithSomePrivateConstructors;
import com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.ExceptionWithWrongTypesConstructor;
import com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.ExceptionWithoutThrowableConstructor;
import com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.TwoArgConstructorException;
import com.github.lafa.cache.util.concurrent.FuturesGetCheckedInputs.TwoArgConstructorRuntimeException;
