 ...
 *
 * <p>
 * GWT can serialize an absent {@code Optional} on its own, but the resulting object is a different
 * instance than the singleton {@code Absent.INSTANCE}, which breaks equality. We implement a custom
 * serializer to maintain the singleton property.
 *
 * @author Chris Povirk
 */
@GwtCompatible
