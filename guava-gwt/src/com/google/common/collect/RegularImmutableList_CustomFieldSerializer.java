...
public class RegularImmutableList_CustomFieldSerializer {
  ...
  public static void deserialize(SerializationStreamReader reader, RegularImmutableList<?> instance) {}
  ...
  public static RegularImmutableList<Object> instantiate(SerializationStreamReader reader)
    ...
    /*
     * For this custom field serializer to be invoked, the list must have been RegularImmutableList
     * before it's serialized. Since RegularImmutableList always have one or more elements,
     * ImmutableList.copyOf always return a RegularImmutableList back.
     */
