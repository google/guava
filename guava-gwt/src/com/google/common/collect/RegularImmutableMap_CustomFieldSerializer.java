...
public class RegularImmutableMap_CustomFieldSerializer {
  ...
  public static RegularImmutableMap<Object, Object> instantiate(SerializationStreamReader reader)
    ...
    /*
     * For this custom field serializer to be invoked, the map must have been RegularImmutableMap
     * before it's serialized. Since RegularImmutableMap always have two or more elements,
     * ImmutableMap.copyOf always return a RegularImmutableMap back.
     */
