...
public class ImmutableSetMultimap_CustomFieldSerializer {
  ...
  public static ImmutableSetMultimap<Object, Object> instantiate(SerializationStreamReader reader)
    ...
    return (ImmutableSetMultimap<Object, Object>) Multimap_CustomFieldSerializerBase.instantiate(
        reader, builder);
  }

  public static void serialize(SerializationStreamWriter writer, ImmutableSetMultimap<?, ?> instance)
      throws SerializationException {
