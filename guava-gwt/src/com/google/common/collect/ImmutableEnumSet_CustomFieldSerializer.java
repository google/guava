...
public class ImmutableEnumSet_CustomFieldSerializer {
  ...
  public static <E extends Enum<E>> ImmutableEnumSet<?> instantiate(SerializationStreamReader reader)
      throws SerializationException {
    List<E> deserialized = Lists.newArrayList();
    Collection_CustomFieldSerializerBase.deserialize(reader, deserialized);
    /*
     * It is safe to cast to ImmutableEnumSet because in order for it to be serialized as an
     * ImmutableEnumSet, it must be non-empty to start with.
     */
