...
public class RegularImmutableSet_CustomFieldSerializer {
  ...
  public static void deserialize(SerializationStreamReader reader, RegularImmutableSet<?> instance) {}
  ...
  public static RegularImmutableSet<Object> instantiate(SerializationStreamReader reader)
    ...
    /*
     * For this custom field serializer to be invoked, the set must have been RegularImmutableSet
     * before it's serialized. Since RegularImmutableSet always have two or more elements,
     * ImmutableSet.copyOf always return a RegularImmutableSet back.
     */
