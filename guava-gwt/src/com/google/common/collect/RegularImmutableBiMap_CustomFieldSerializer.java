...
public class RegularImmutableBiMap_CustomFieldSerializer {
  ...
  public static RegularImmutableBiMap<Object, Object> instantiate(SerializationStreamReader reader)
    ...
    /*
     * For this custom field serializer to be invoked, the map must have been RegularImmutableBiMap
     * before it's serialized. Since RegularImmutableBiMap always have one or more elements,
     * ImmutableBiMap.copyOf always return a RegularImmutableBiMap back.
     */
