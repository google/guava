...
public class CacheBuilderGwtTest {
  ...
  public void loadingCache() throws ExecutionException {
    ...
    assertThat(map.get(10)).isEqualTo(20);
    assertThat(map.get(20)).isEqualTo(0);
    assertThat(map.get(30)).isEqualTo(1);
    assertThat(map.get(54)).isEqualTo(2);
    assertThat(map.get(443)).isEqualTo(3);
  ...
  public void asMapKeySet() {
    ...
    assertThat(foundKeys).isEqualTo(ImmutableSet.of(20, 5));
  }
