...
interface SortedIterable<T> extends Iterable<T> {
  /**
   * Returns the {@code Comparator} by which the elements of this iterable are ordered, or
   * {@code Ordering.natural()} if the elements are ordered by their natural ordering.
   */
