 ...
 * according to the value comparator ordering or the natural ordering of the values. The collections
 * generated by {@code entries}, {@code keys}, and {@code values} iterate across the keys according
 * to the above key ordering, and for each key they iterate across the values according to the value
 * ordering.
 *
 * <p>
...
public class TreeMultimap<K, V> extends AbstractSortedKeySortedSetMultimap<K, V> {
   ...
   * AbstractSortedKeySortedSetMultimap, so GWT will fall back to the ASKSSM implementations, which
   * return SortedSets and SortedMaps.
   */
