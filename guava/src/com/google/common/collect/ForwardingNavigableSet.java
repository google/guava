 ...
 *
 * <p>
 * <i>Warning:</i> The methods of {@code ForwardingNavigableSet} forward <i>indiscriminately</i> to
...
public abstract class ForwardingNavigableSet<E> extends ForwardingSortedSet<E> implements
   ...
   *
   * <p>
   * In many cases, you may wish to override {@link ForwardingNavigableSet#descendingSet} to forward
   ...
   */
  @Beta
  protected NavigableSet<E> standardSubSet(E fromElement, boolean fromInclusive, E toElement,
      boolean toInclusive) {
