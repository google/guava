...
final class Serialization {
   ...
   * of distinct keys in a multimap serialized by
  ...
  /**
   * Populates a multiset by reading an input stream, as part of deserialization. See
   * {@link #writeMultiset} for the data format. The number of distinct elements is determined by a
   ...
   *
   * <p>
   * The serialized output consists of the number of distinct keys, and then for each distinct key:
   * the key, the number of values for that key, and the key's values.
   */
