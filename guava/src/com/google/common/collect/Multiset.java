 ...
 * used in this API). Since the count of an element is represented as an {@code int}, a multiset may
 * never contain more than {@link Integer#MAX_VALUE} occurrences of any one element.
 *
 * <p>
...
public interface Multiset<E> extends Collection<E> {
   ...
   * Note that if {@code occurrences == 1}, this is functionally equivalent to the call
   * {@code remove(element)}.
   *
   ...
   * @throws NullPointerException if {@code element} is null and this implementation does not permit
   *         null elements. Note that if {@code count} is zero, the implementor may optionally
   *         return zero instead.
   */
   ...
   *
   * <p>
   * over all distinct elements in the multiset. It follows that a multiset and its entry set always
   ...
   *
   * <p>
   * This method refines {@link Collection#contains} to further specify that it <b>may not</b> throw
   ...
   * two collections; it may still return {@code true} even if {@code elements} contains several
