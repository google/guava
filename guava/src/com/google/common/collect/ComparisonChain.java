 ...
 * {@code compare} methods unconditionally, the {@code ComparisonChain} implementation stops calling
 * its inputs' {@link Comparable#compareTo compareTo} and {@link Comparator#compare compare} methods
 * as soon as one of them returns a nonzero result. This optimization is typically important only in
