...
abstract class ImmutableSortedSetFauxverideShim<E> extends ImmutableSet<E> {
   ...
   * @throws UnsupportedOperationException always
   * @deprecated <b>Pass the parameters of type {@code Comparable} to use
   *             {@link ImmutableSortedSet#of(Comparable, Comparable, Comparable, Comparable)}. </b>
   */
  @Deprecated
   ...
   * copyOf() here, and the definition in ImmutableSortedSet matches that in ImmutableSet.
   * 
