...
public interface Interner<E> {
   ...
   * and {@code intern(a) == intern(b)} if and only if {@code a.equals(b)}. Note that
   * {@code intern(a)} is permitted to return one instance now and a different instance later if the
