...
public abstract class TreeTraverser<T> {
   ...
   *
   * <p>
   * No guarantees are made about the behavior of the traversal when nodes change while iteration is
   * in progress or when the iterators generated by {@link #children} are advanced.
   */
  ...
  private final class BreadthFirstIterator extends UnmodifiableIterator<T> implements
      PeekingIterator<T> {
