...
public interface BiMap<K, V> extends Map<K, V> {
   ...
   *         bimap. The bimap will remain unmodified in this event. To avoid this exception, call
   *         {@link #forcePut} instead.
   */
  @Override
   ...
   *
   * <p>
   * <b>Warning:</b> the results of calling this method may vary depending on the iteration order of
   * {@code map}.
   *
