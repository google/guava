...
public interface RangeMap<K extends Comparable, V> {
   ...
   * 
   * <p>
   * The returned range map will throw an {@link IllegalArgumentException} on an attempt to insert a
   * range not {@linkplain Range#encloses(Range) enclosed} by {@code range}.
   */
