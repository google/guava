...
final class Constraints {
  ...
  /**
   * Returns a constrained view of the specified collection, using the specified constraint. Any
   * operations that add new elements to the collection will call the provided constraint. However,
   * this method does not verify that existing elements satisfy the constraint.
   *
   * <p>
  ...
  /**
   * Returns a constrained view of the specified set, using the specified constraint. Any operations
   * that add new elements to the set will call the provided constraint. However, this method does
   * not verify that existing elements satisfy the constraint.
   *
   * <p>
  ...
  /**
   * Returns a constrained view of the specified sorted set, using the specified constraint. Any
   * operations that add new elements to the sorted set will call the provided constraint. However,
   * this method does not verify that existing elements satisfy the constraint.
   *
   * <p>
   * The returned set is not serializable.
  ...
  /**
   * Returns a constrained view of the specified list, using the specified constraint. Any
   * operations that add new elements to the list will call the provided constraint. However, this
   * method does not verify that existing elements satisfy the constraint.
   *
   * <p>
   * If {@code list} implements {@link RandomAccess}, so will the returned list. The returned list
   * is not serializable.
   *
  ...
  /**
   * Returns a constrained view of the specified list iterator, using the specified constraint. Any
   * operations that would add new elements to the underlying list will be verified by the
   * constraint.
   *
  ...
  /*
   * TODO(kevinb): For better performance, avoid making a copy of the elements by having addAll()
   * call add() repeatedly instead.
   */
