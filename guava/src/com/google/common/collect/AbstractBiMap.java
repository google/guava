...
abstract class AbstractBiMap<K, V> extends ForwardingMap<K, V> implements BiMap<K, V>, Serializable {
  ...
  public Set<V> values() {
    /*
     * We can almost reuse the inverse's keySet, except we have to fix the iteration order so that
     * it is consistent with the forward map.
     */
  ...
  private class EntrySet extends ForwardingSet<Entry<K, V>> {
    ...
    public boolean remove(Object object) {
      ...
      /*
       * Remove the mapping in inverse before removing from esDelegate because if entry is part of
       * esDelegate, entry might be invalidated after the mapping is removed from esDelegate.
       */
  ...
  private static class Inverse<K, V> extends AbstractBiMap<K, V> {
    ...
    /*
     * Serialization stores the forward bimap, the inverse of this inverse. Deserialization calls
     * inverse() on the forward bimap and returns that inverse.
     * 
     * If a bimap and its inverse are serialized together, the deserialized instances have inverse()
     * methods that return the other.
     */
