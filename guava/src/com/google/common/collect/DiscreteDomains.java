...
public final class DiscreteDomains {
  ...
  private static final DiscreteDomain<Integer> INTEGERS =
  ...
  private static DiscreteDomain<Long> LONGS =
      new DiscreteDomain<Long>() {
  ...
  private static final DiscreteDomain<BigInteger> BIG_INTEGERS =
      new DiscreteDomain<BigInteger>() {
