...
public abstract class ContiguousSet<C extends Comparable> extends ImmutableSortedSet<C> {
   ...
   *
   * <p>
   * Note that this method will return ranges with unbounded endpoints if {@link BoundType#OPEN} is
   * requested for a domain minimum or maximum. For example, if {@code set} was created from the
   ...
   * method exists only to hide {@link ImmutableSet#builder} from consumers of {@code ContiguousSet}
   * .
   *
