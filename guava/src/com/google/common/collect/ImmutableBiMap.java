...
/**
 * An immutable {@link BiMap} with reliable user-specified iteration order. Does not permit null
 * keys or values. An {@code ImmutableBiMap} and its inverse have the same iteration ordering.
 *
 * <p>
 * An instance of {@code ImmutableBiMap} contains its own data and will <i>never</i> change.
 * {@code ImmutableBiMap} is convenient for {@code public static final} maps ("constant maps") and
 * also lets you easily make a "defensive copy" of a bimap provided to your class by a caller.
 *
 * <p>
...
public abstract class ImmutableBiMap<K, V> extends ImmutableMap<K, V> implements BiMap<K, V> {
   ...
   *       new ImmutableBiMap.Builder&lt;String, Integer&gt;().put(&quot;one&quot;, 1).put(&quot;two&quot;, 2).put(&quot;three&quot;, 3)
   *           .build();
   * }
   * </pre>
   *
