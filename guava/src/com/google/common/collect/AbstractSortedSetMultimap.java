...
abstract class AbstractSortedSetMultimap<K, V> extends AbstractSetMultimap<K, V> implements
   ...
   *
   * <p>
   * When passed a key that is present in the map, {@code asMap().get(Object)} has the same behavior
   * as {@link #get}, returning a live collection. When passed a key that is not present, however,
   * {@code asMap().get(Object)} returns {@code null} instead of an empty collection.
   *
   * <p>
