 ...
 * {@code loadExceptionCount} are incremented, and the total loading time, in nanoseconds, is added
...
public final class CacheStats {
   ...
   *
   * <p>
   * Five parameters of the same type in a row is a bad thing, but this class is not constructed by
   * end users and is too fine-grained for a builder.
   */
   ...
   * value. This is always incremented in conjunction with {@code missCount}, though
