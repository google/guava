...
public interface LoadingCache<K, V> extends Cache<K, V>, Function<K, V> {
   ...
   *         href="http://code.google.com/p/guava-libraries/wiki/CachesExplained#Interruption">even
   ...
   *
   * <p>
   * Returns without doing anything if another thread is currently loading the value for {@code key}
