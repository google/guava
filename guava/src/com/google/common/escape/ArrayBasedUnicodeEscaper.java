...
public abstract class ArrayBasedUnicodeEscaper extends UnicodeEscaper {
   ...
   *
   * <p>
   * If a code point has no mapped replacement then it is checked against the safe range. If it lies
   * outside that, then {@link #escapeUnsafe} is called, otherwise no escaping is performed.
   *
   ...
   */
  protected ArrayBasedUnicodeEscaper(Map<Character, String> replacementMap, int safeMin,
      int safeMax, @Nullable String unsafeReplacement) {
