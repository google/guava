...
public final class Escapers {
   ...
   *
   * <p>
   * Typically an escaper needs to deal with the escaping of high valued characters or code points.
   * In these cases it is necessary to extend either {@link ArrayBasedCharEscaper} or
  ...
  public static final class Builder {
    ...
    public Escaper build() {
      return new ArrayBasedCharEscaper(replacementMap, safeMin, safeMax) {
        private final char[] replacementChars = unsafeReplacement != null ? unsafeReplacement
            .toCharArray() : null;
