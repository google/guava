 ...
 * {@link com.google.common.html.HtmlEscapers}, {@link com.google.common.xml.XmlEscapers}, and
 * {@link SourceCodeEscapers}. To create your own escapers extend this class and implement the
    ...
    if (index < end) {
      ...
      if (c1 < Character.MIN_HIGH_SURROGATE || c1 > Character.MAX_LOW_SURROGATE) {
        ...
        throw new IllegalArgumentException("Expected low surrogate but got char '" + c2
            + "' with value " + (int) c2 + " at index " + index + " in '" + seq + "'");
      } else {
        throw new IllegalArgumentException("Unexpected low surrogate character '" + c1
            + "' with value " + (int) c1 + " at index " + (index - 1) + " in '" + seq + "'");
      }
    }
