...
public abstract class HashCode {
   ...
   *
   * <p>
   * Note that if the output is considered to be a single hexadecimal number, this hash code's bytes
   * are the <i>big-endian</i> representation of that number. This may be surprising since
