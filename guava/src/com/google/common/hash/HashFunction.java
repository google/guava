 ...
 *
 * <p>
 * The primary way to provide the data that your hash function should act on is via a {@link Hasher}
 * . Obtain a new hasher from the hash function using {@link #newHasher}, "push" the relevant data
 * into it using methods like {@link Hasher#putBytes(byte[])}, and finally ask for the
 ...
 * that you implement a {@link Funnel Funnel<T>} to specify how to "feed" data from that object into
 * the function. (See {@linkplain Hasher#putObject an example} of this.)
 *
 * <p>
