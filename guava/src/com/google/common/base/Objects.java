...
public final class Objects {
   ...
   * with {@linkplain Optional#or(Object) first.or(second)}. That approach also allows for lazy
   * evaluation of the fallback instance, using {@linkplain Optional#or(Supplier)
   * first.or(Supplier)}.
   *
