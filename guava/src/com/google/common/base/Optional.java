 ...
 * (though there are <a
 * href="http://code.google.com/p/guava-libraries/wiki/LivingWithNullHostileCollections"> several
...
public abstract class Optional<T> implements Serializable {
   ...
   * {@code Optional<T>}. Casting either of the above example {@code Optional} instances to
