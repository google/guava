...
public final class Ascii {
   ...
   *
   * <p>
   * This method is significantly faster than {@link String#equalsIgnoreCase} and should be used in
   * preference if at least one of the parameters is known to contain only ASCII characters.
   *
   * <p>
