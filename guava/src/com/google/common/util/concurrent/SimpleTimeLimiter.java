...
public final class SimpleTimeLimiter implements TimeLimiter {
   ...
   * calls.
   * <p>
   * <b>Warning:</b> using a bounded executor may be counterproductive! If the thread pool fills up,
   * any time callers spend waiting for a thread may count toward their time limit, and in this case
   * the call may even time out before the target method is ever invoked.
   *
  ...
  private static <T> T newProxy(Class<T> interfaceType, InvocationHandler handler) {
    Object object =
        Proxy.newProxyInstance(interfaceType.getClassLoader(), new Class<?>[] {interfaceType},
            handler);
