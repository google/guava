 ...
 *
 * <p>If the steps of your pipeline create objects that must be closed when the computation is
 * done, such as database connections or file handles, use {@code ClosingFuture}. It supports the
 * same kinds of derived steps as {@code FluentFuture} but closes those objects once the pipeline
