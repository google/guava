...
public final class Futures extends GwtFuturesCatchingSpecialization {
  ...
  public static <O extends @Nullable Object> ListenableFuture<O> scheduleAsync(
    ...
    TrustedListenableFutureTask<O> task = TrustedListenableFutureTask.create(callable);
    final Future<? extends @Nullable Object> scheduled =
  ...
  public static final class FutureCombiner<V extends @Nullable Object> {
     ...
     * @since 23.6
     */
    public ListenableFuture<? extends @Nullable Object> run(
        final Runnable combiner, Executor executor) {
      return call(
  ...
  private static final class InCompletionOrderState<T extends @Nullable Object> {
    ...
    private InCompletionOrderState(@Nullable ListenableFuture<? extends T>[] inputFutures) {
  ...
  private static final class CallbackListener<V extends @Nullable Object> implements Runnable {
    ...
    public void run() {
      ...
      try {
         ...
         * cause. But see AbstractFuture.getFutureValue.
         */
        callback.onFailure(requireNonNull(e.getCause()));
        return;
  ...
  public static <V extends @Nullable Object> V getUnchecked(Future<V> future) {
    ...
    try {
      ...
      /*
       * requireNonNull should be safe because an ExecutionException from a Future should have a
       * cause. In some similar cases, we may want to handle null more gracefully, as discussed in
       * AbstractFuture.getFutureValue. However, in this particular case, all we're doing is
       * throwing an exception, so there's not much we could do differently. That's fine: Unlike in
       * some of the similar cases, we're not responsible for notifying listeners.
       */
      wrapAndThrowUnchecked(requireNonNull(e.getCause()));
