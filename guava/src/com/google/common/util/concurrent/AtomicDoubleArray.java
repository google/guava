...
public class AtomicDoubleArray implements Serializable {
   ...
   * by {@link java.lang.invoke.VarHandle#getVolatile VarHandle.getVolatile}. The returned value is
   * the {@code double} whose bitwise representation was stored atomically as a single 64-bit
   * value.
   *
   * @param i the index
   ...
   * {@link java.lang.invoke.VarHandle#setVolatile VarHandle.setVolatile}. The value is stored by
   * atomically writing the 64-bit representation of {@code newValue}.
   *
   * @param i the index
  ...
  /**
   * Sets the element at index {@code i} to {@code newValue}, with memory effects as specified by
   * {@link java.lang.invoke.VarHandle#setRelease VarHandle.setRelease}. The value is stored by
   * atomically writing the 64-bit representation of {@code newValue}; the store may be delayed and
   * is ordered differently than {@link #set(int, double)}.
   *
   * @param i the index
   * @param newValue the new value
   */
