 ...
 * execution has not been suspended. {@code RuntimeException}s thrown by tasks are simply logged and
 * the executor keeps trucking. If an {@code Error} is thrown, the error will propagate and
 * execution will stop until it is restarted by external calls.
 */
