...
public final class Uninterruptibles {
   ...
   *
   * <p>
   * If instead, you wish to treat {@link InterruptedException} uniformly with other exceptions, see
   * {@link Futures#get(Future, Class) Futures.get} or {@link Futures#makeChecked}.
   *
   ...
   */
  @GwtIncompatible("concurrency")
  public static boolean tryAcquireUninterruptibly(Semaphore semaphore, int permits, long timeout,
      TimeUnit unit) {
    boolean interrupted = false;
    try {
      long remainingNanos = unit.toNanos(timeout);
