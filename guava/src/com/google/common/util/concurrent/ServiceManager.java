...
public final class ServiceManager {
   ...
   *
   * <p>
   * Users who want more detailed information should use the {@link #servicesByState} method to get
   * detailed information about which services are not running.
   */
  ...
  private static final class ServiceManagerState {
     ...
     * {@link #markReady} to indicate that all listeners have been correctly installed
     * {@link #transitioned}: is set by {@link #transitionService} to indicate that some transition
     * has been performed.
     *
     * <p>
     * Together, they allow us to enforce that all services have their listeners installed prior to
     * any service performing a transition, then we can fail in the ServiceManager constructor
    ...
    ImmutableMap<Service, Long> startupTimes() {
      ...
      Collections.sort(loadTimes,
          Ordering.<Long>natural().onResultOf(new Function<Entry<Service, Long>, Long>() {
            @Override
