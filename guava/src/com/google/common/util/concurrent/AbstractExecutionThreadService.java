...
public abstract class AbstractExecutionThreadService implements Service {
   ...
   * {@link Executor#execute(Runnable) execute()} method is called when this service is started, and
   * should return promptly.
   * 
   * <p>
   * The default implementation returns a new {@link Executor} that sets the name of its threads to
   * the string returned by {@link #serviceName}
   */
