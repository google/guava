 ...
 * that, whenver possible, it is strongly preferred to modify those libraries to return
 * {@code ListenableFuture} directly.
 *
 * @author Sven Mawson
...
public final class JdkFutureAdapters {
   ...
   * {@code Future} instances to be upgraded to {@code ListenableFuture} after the fact.
   */
      ...
      if (hasListeners.compareAndSet(false, true)) {
        ...
        adapterExecutor.execute(new Runnable() {
          ...
          public void run() {
            try {
              /*
               * Threads from our private pool are never interrupted. Threads from a user-supplied
               * executor might be, but... what can we do? This is another reason to return a proper
               * ListenableFuture instead of using listenInPoolThread.
               */
