 ...
 * example, if one wants to create a {@code Striped<Lock>} of many locks, but worries that in most
 * cases only a small portion of these would be in use.
 *
 * <p>
...
public abstract class Striped<L> {
  ...
  public Iterable<L> bulkGet(Iterable<?> keys) {
     ...
     * stripedLock.bulkGet(keys); for (Lock lock : locks) { lock.lock(); } operation(); for (Lock
