 ...
 * and cannot be used as a replacement for a {@link Double}. However, this class does extend
 * {@code Number} to allow uniform access by tools and utilities that deal with numerically-based
 * classes.
 *
 * <p>
 * <a name="bitEquals">This class compares primitive {@code double} values in methods such as
