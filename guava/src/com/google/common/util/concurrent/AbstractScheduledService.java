 ...
 * {@link #runOneIteration} that will be executed periodically as specified by its {@link Scheduler}
 * . When this service is asked to stop via {@link #stopAsync} it will cancel the periodic task (but
 * not interrupt it) and wait for it to stop before running the {@link #shutDown} method.
 * 
 * <p>
...
public abstract class AbstractScheduledService implements Service {
   ...
   * . Subclasses may override this method to supply a custom {@link ScheduledExecutorService}
   * instance. This method is guaranteed to only be called once.
   * 
   * <p>
   * By default this returns a new {@link ScheduledExecutorService} with a single thread thread pool
  ...
  public abstract static class CustomScheduler extends Scheduler {
     ...
     * 
     * <p>
     * This is guaranteed to be called immediately after the task has completed an iteration and on
     * the same thread as the previous execution of {@link AbstractScheduledService#runOneIteration}.
     * 
