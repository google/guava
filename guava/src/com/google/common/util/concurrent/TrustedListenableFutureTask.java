...
class TrustedListenableFutureTask<V> extends AbstractFuture.TrustedFuture<V> implements
    RunnableFuture<V> {
   ...
   *
   * <p>
   * Extracted as an extension point for subclasses that wish to modify behavior. See
   * Futures.combine (which has specialized exception handling).
   */
