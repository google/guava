...
public final class DoubleMath {
  ...
  /**
   * Returns the arithmetic mean of the values. There must be at least one value. The values will be
   * converted to doubles, which does not cause any loss of precision for ints.
   */
  @GwtIncompatible("MeanAccumulator")
  ...
  /**
   * Returns the arithmetic mean of the values. There must be at least one value. The values will be
   * converted to doubles, which causes loss of precision for longs of magnitude over 2^53 (slightly
   * over 9e15).
   */
  @GwtIncompatible("MeanAccumulator")
