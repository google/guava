...
public final class Quantiles {
  ...
  @SuppressWarnings(value = {"lowerbound:assignment.type.incompatible",/*(1): When entering the loop,
          ...
          "upperbound:assignment.type.incompatible"/*(2): Entering the loop, from and to < array.length. While to > from,
          to > partitionPoint + 1, therefore partitionPoint + 1 < array.length */})
