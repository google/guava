...
public final class Longs {
   ...
   *
   * <p>
   * If you need to convert and concatenate several values (possibly even of different types), use a
   * shared {@link java.nio.ByteBuffer} instance, or use
   ...
   *
   * <p>
   * Unlike {@link Long#parseLong(String)}, this method returns {@code null} instead of throwing an
   * exception if parsing fails. Additionally, this method only accepts ASCII digits, and returns
   ...
   * {@link Long#decode} and {@link Long#toString()}.
   *
   * @since 16.0
   */
  @Beta
   ...
   *
   * <p>
   * The returned list maintains the values, but not the identities, of {@code Long} objects written
   * to or read from it. For example, whether {@code list.get(0) == list.get(0)} is true for the
