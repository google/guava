...
public final class Shorts {
   ...
   * concat(new short[] a, b}, new short[] {}, new short[] {c}} returns the array {@code a, b, c}}.
   *
   ...
   * {@code ByteBuffer.allocate(2).putShort(value).array()}. For example, the input value
  ...
  private static final class ShortConverter extends Converter<String, Short> implements
      Serializable {
   ...
   * {@link Short#decode} and {@link Short#toString()}.
   *
   * @since 16.0
   */
  @Beta
   ...
   * lesser. For example, {@code [] < [(short) 1] <
