...
public final class Floats {
   ...
   * concat(new float[] a, b}, new float[] {}, new float[] {c}} returns the array {@code a, b, c}}.
   *
  ...
  private static final class FloatConverter extends Converter<String, Float> implements
      Serializable {
  ...
  /**
   * Returns a comparator that compares two {@code float} arrays lexicographically. That is, it
   * compares, using {@link #compare(float, float)}), the first pair of values that follow any
   * common prefix, or when one array is a prefix of the other, treats the shorter array as the
   * lesser. For example, {@code [] < [1.0f] < [1.0f, 2.0f]
   * < [2.0f]}.
   *
   * <p>
   ...
   *
   * <p>
   * This implementation is likely to be faster than {@code Float.parseFloat} if many failures are
   * expected.
   *
