...
public class EventBus {
  ...
  public EventBus(String identifier) {
    this(identifier, MoreExecutors.directExecutor(), Dispatcher.perThreadDispatchQueue(),
  ...
  public EventBus(SubscriberExceptionHandler exceptionHandler) {
    this("default", MoreExecutors.directExecutor(), Dispatcher.perThreadDispatchQueue(),
        exceptionHandler);
  }
  ...
  static final class LoggingHandler implements SubscriberExceptionHandler {
    ...
    private static String message(SubscriberExceptionContext context) {
      ...
      return "Exception thrown by subscriber method " + method.getName() + '('
          ...
          + context.getSubscriber() + " when dispatching event: " + context.getEvent();
    }
  }
}
