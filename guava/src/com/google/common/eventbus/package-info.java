 ...
 * "http://code.google.com/p/guava-libraries/wiki/EventBusExplained"> {@code EventBus}</a>.
 *
 ...
 * &mdash; such as CustomerChangeEventListener.</li>
 * <li><strong>...with EventBus:</strong> create a method that accepts CustomerChangeEvent as its
 * sole argument, and mark it with the {@link com.google.common.eventbus.Subscribe} annotation.</li>
 * </ul>
 *
 * <p>
 ...
 * interfaces, so in addition to knowing every possible producer, you must also know its type.</li>
 ...
 * to make sure that your object shares an EventBus instance with the event producers.</li>
 * </ul>
 *
 * <p>
 ...
 * supertype, allowing listeners for interface types or "wildcard listeners" for Object.</li>
 * </ul>
 *
 * <p>
 ...
 * your object, including synchronization, or use a utility class like EventListenerList.</li>
 ...
 * event listener, including error isolation and (if desired) asynchronicity.</li>
 ...
 * <dt>Listener</dt>
 * <dd>An object that wishes to receive events, by exposing <em>subscriber methods</em>.</dt>
 * <dt>Subscriber method</dt>
 * <dd>A public method that the EventBus should use to deliver <em>posted</em> events. Subscriber
 * methods are marked by the {@link com.google.common.eventbus.Subscribe} annotation.</dd>
 * <dt>Posting an event</dt>
 * <dd>Making the event available to any <em>listeners</em> through the EventBus.</dt>
 * </dl>
 *
 * <h2>FAQ</h2>
