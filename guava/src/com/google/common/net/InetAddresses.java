 ...
 * <li><a target="_parent" href="http://www.space.net/~gert/RIPE/ipv6-filters.html"
...
public final class InetAddresses {
   ...
   *
   * <p>
   * This method uses hexadecimal for all IPv6 addresses, including IPv4-mapped IPv6 addresses such
   * as "::c000:201". The output does not include a Scope ID.
   *
   ...
   *
   * <p>
   * Only runs of two or more hextets are considered. In case of a tie, the leftmost run wins. If a
   * qualifying run is found, its hextets are replaced by the sentinel value -1.
   *
  ...
  private static String hextetsToIPv6String(int[] hextets) {
    /*
     * While scanning the array, handle these state transitions: start->num => "num" start->gap =>
     * "::" num->num => ":num" num->gap => "::" gap->num => "num" gap->gap => ""
     */
   ...
   *
   * <p>
   * Use of either {@link InetAddresses#toAddrString}, {@link InetAddress#getHostAddress()}, or this
   * method is recommended over {@link InetAddress#toString()} when an IP address string literal is
   * desired. This is because {@link InetAddress#toString()} prints the hostname and the IP address
   * string joined by a "/".
   *
   ...
   *
   * <p>
   * This function is similar to {@link InetAddresses#forString(String)}, however, it requires that
   ...
   *
   * <p>
   * 6to4 addresses begin with the {@code "2002::/16"} prefix. The next 32 bits are the IPv4 address
   * of the host to which IPv6-in-IPv4 tunneled packets should be routed.
   *
   * <p>
   * For more on 6to4 addresses see section 2 of <a target="_parent"
   * href="http://tools.ietf.org/html/rfc3056#section-2" >http://tools.ietf.org/html/rfc3056</a>
   *
   ...
   *
   * <p>
   * All of the fields in this class are encoded in various portions of the IPv6 address as part of
   * the protocol. More protocols details can be found at: <a target="_parent"
   * href="http://en.wikipedia.org/wiki/Teredo_tunneling"
   * >http://en.wikipedia.org/wiki/Teredo_tunneling</a>.
   *
   * <p>
   * The RFC can be found here: <a target="_parent" href="http://tools.ietf.org/html/rfc4380"
  ...
  public static final class TeredoInfo {
     ...
     *
     * <p>
     * Both server and client can be {@code null}, in which case the value {@code "0.0.0.0"} will be
     * assumed.
     *
   ...
   *
   * <p>
   * From RFC 5214: "ISATAP interface identifiers are constructed in Modified EUI-64 format [...] by
   * concatenating the 24-bit IANA OUI (00-00-5E), the 8-bit hexadecimal value 0xFE, and a 32-bit
   * IPv4 address in network byte order [...]"
   *
   * <p>
   * For more on ISATAP addresses see section 6.1 of <a target="_parent"
   * href="http://tools.ietf.org/html/rfc5214#section-6.1" >http://tools.ietf.org/html/rfc5214</a>
   *
   ...
   *
   * <p>
   * As long as there are applications that assume that all IP addresses are IPv4 addresses and can
   * therefore be converted safely to integers (for whatever purpose) this function can be used to
   * handle IPv6 addresses as well until the application is suitably fixed.
   *
   * <p>
  ...
  private static IllegalArgumentException formatIllegalArgumentException(String format,
      Object... args) {
