...
public final class PercentEscaper extends UnicodeEscaper {
   ...
   *
   * <p>
   * Not that it is allowed, but not necessarily desirable to specify {@code %} as a safe character.
   * This has the effect of creating an escaper which has no well defined inverse but it can be
   * useful when escaping additional characters.
   *
