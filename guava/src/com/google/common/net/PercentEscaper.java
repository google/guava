 ...
 * UTF-8 based percent enconding scheme. The set of safe characters (those which
 * remain unescaped) can be specified on construction.
 *
 * <p>This class is primarily used for creating URI escapers in
 * {@link com.google.common.net.UriEscapers} but can be used directly if
 * required. While URI escapers impose specific semantics on which characters
 * are considered 'safe', this class has a minimal set of restrictions.
 *
