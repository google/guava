...
public final class UrlEscapers {
   ...
   * href="http://goo.gl/OQEc8">URL form parameter names and values</a>. Escaping is performed with
   * the UTF-8 character encoding. The caller is responsible for <a
   * href="http://goo.gl/i20ms">replacing any unpaired carriage return or line feed characters with
   * a CR+LF pair</a> on any non-file inputs before escaping them with this escaper.
   *
   * <p>
   ...
   * href="http://goo.gl/utn6M">using the non-standard semicolon</a>, rather than the ampersand, as
   ...
   *
   * <p>
   * <b>Note:</b> Unlike other escapers, URL escapers produce uppercase hexadecimal sequences. From
  ...
  private static final Escaper URL_FORM_PARAMETER_ESCAPER = new PercentEscaper(
      URL_FORM_PARAMETER_OTHER_SAFE_CHARS, true);

  /**
   * Returns an {@link Escaper} instance that escapes strings so they can be safely included in <a
   * href="http://goo.gl/swjbR">URL path segments</a>. The returned escaper escapes all non-ASCII
   ...
   * href="http://goo.gl/xXEq4p">URL fragment</a>. The returned escaper escapes all non-ASCII
   * characters, even though <a href="http://goo.gl/xIJWe">many of these are accepted in modern
   * URLs</a>. (<a href="http://goo.gl/WMGvZ">If the escaper were to leave these characters
