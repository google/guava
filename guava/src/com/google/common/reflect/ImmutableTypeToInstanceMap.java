...
public final class ImmutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B>
   ...
   *
   * <p>
   * After invoking {@link #build()} it is still possible to add more entries and build again. Thus
   * each map generated by this builder will be a superset of any map generated before it.
   *
   * @since 13.0
   */
  @Beta
