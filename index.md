...
These flavors are specified in the Maven version field as either `{{
site.latest_release }}-jre` or `{{ site.latest_release }}-android`. For more
about depending on Guava, see [using Guava in your build].
