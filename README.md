...
These flavors are specified in the Maven version field as either `33.4.5-jre` or
`33.4.5-android`. For more about depending on Guava, see
...
dependencies {
  ...
  api("com.google.guava:guava:33.4.5-android")
}
```
