...
These flavors are specified in the Maven version field as either `33.7.0-jre` or
`33.7.0-android`. For more about depending on Guava, see
...
dependencies {
  ...
  api("com.google.guava:guava:33.7.0-android")
}
```
