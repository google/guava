  ...
  public static Test suite() {
    ...
    suite.addTest(
        NavigableMapTestSuiteBuilder.using(
             ...
             * supports setValue().
             */
            .suppressing(MapEntrySetTester.getSetValueMethod(), MapEntrySetTester.getSetValueWithNullValuesAbsentMethod(), MapEntrySetTester.getSetValueWithNullValuesPresentMethod())
            .createTestSuite());
