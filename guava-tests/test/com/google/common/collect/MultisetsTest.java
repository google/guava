...
public class MultisetsTest extends TestCase {
  ...
  public void testNewTreeMultisetDerived() {
    ...
    assertThat(set).containsExactly(new DerivedComparable("bar"), new DerivedComparable("bar"),
  ...
  public void testNewTreeMultisetNonGeneric() {
    ...
    assertThat(set).containsExactly(new LegacyComparable("bar"), new LegacyComparable("bar"),
        new LegacyComparable("bar"), new LegacyComparable("foo"), new LegacyComparable("foo"))
        .inOrder();
  }
