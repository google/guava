...
public class ImmutableEnumMapTest extends TestCase {
  ...
  public static Test suite() {
    ...
    suite.addTest(MapTestSuiteBuilder
        .using(new ImmutableEnumMapGenerator())
  ...
  public void testImmutableEnumMapOrdering() {
    ...
    assertThat(map.entrySet()).containsExactly(Helpers.mapEntry(AnEnum.A, "a"),
        Helpers.mapEntry(AnEnum.C, "c"), Helpers.mapEntry(AnEnum.E, "e")).inOrder();
  }
}
