...
public class TreeBasedTableTest extends AbstractTableTest {
  ...
  public static Test suite() {
    ...
    suite.addTest(SortedMapTestSuiteBuilder
        ...
        .withFeatures(MapFeature.GENERAL_PURPOSE, CollectionFeature.SUPPORTS_ITERATOR_REMOVE,
            CollectionSize.ANY).named("RowMapTestSuite").createTestSuite());
    return suite;
  }
  ...
  protected TreeBasedTable<String, Integer, Character> create(
      Comparator<? super String> rowComparator, Comparator<? super Integer> columnComparator,
      Object... data) {
  ...
  public void testColumnKeySet_isSorted() {
    table =
        create("a", 2, 'X', "a", 2, 'X', "b", 3, 'X', "b", 2, 'X', "c", 10, 'X', "c", 10, 'X', "c",
  ...
  public void testColumnKeySet_isSortedWithRealComparator() {
    table =
        create(String.CASE_INSENSITIVE_ORDER, Ordering.natural().reverse(), "a", 2, 'X', "a", 2,
            'X', "b", 3, 'X', "b", 2, 'X', "c", 10, 'X', "c", 10, 'X', "c", 20, 'X', "d", 15, 'X',
            "d", 20, 'X', "d", 1, 'X', "e", 5, 'X');
  ...
  public void testRowEntrySetContains() {
    table =
        sortedTable =
            create("a", 2, 'X', "a", 2, 'X', "b", 3, 'X', "b", 2, 'X', "c", 10, 'X', "c", 10, 'X',
