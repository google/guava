...
public class ImmutableMultimapTest extends TestCase {
  ...
  public void testCopyOf() {
    ...
    assertSame("copyOf(ImmutableSetMultimap) should not create a new instance", setMultimap,
        setMultimapCopy);
    ...
    assertSame("copyOf(ImmutableListMultimap) should not create a new instance", listMultimap,
        listMultimapCopy);
  }
  ...
  public void testUnhashableMixedValues() {
    ...
    Multimap<Integer, Object> multimap =
        ImmutableMultimap.<Integer, Object>of(0, unhashables.e0(), 2, "hey you", 0,
            unhashables.e1());
  ...
  public void testEquals() {
    new EqualsTester()
        ...
        .addEqualityGroup(ImmutableMultimap.of(1, "a", 2, "b"),
            ImmutableMultimap.of(2, "b", 1, "a")).testEquals();
  }
}
