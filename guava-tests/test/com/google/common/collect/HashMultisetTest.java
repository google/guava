...
public class HashMultisetTest extends TestCase {
  ...
  /*
   * The behavior of toString() and iteration is tested by LinkedHashMultiset, which shares a lot of
   * code with HashMultiset and has deterministic iteration order.
   */
}
