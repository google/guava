...
public class SipHashFunctionTest extends TestCase {
  ...
  private static final long[] EXPECTED = new long[] {0x726fdb47dd0e0e31L, 0x74f839c593dc67fdL,
  ...
  public void testCollisionsDueToIncorrectSignExtension() {
    ...
    ImmutableSet<HashCode> hashCodes =
        ImmutableSet.of(SIP_WITH_KEY.hashBytes(col1), SIP_WITH_KEY.hashBytes(col2),
