...
public class Murmur3Hash32Test extends TestCase {
  ...
  public void testKnownUtf8StringInputs() {
    ...
    assertHash(0x3f4aff5c, murmur3_32()
        .hashString(Character.toString(Character.MAX_VALUE), Charsets.UTF_8));
    assertHash(0x81db5903, murmur3_32()
        .hashString(new String(Character.toChars(Character.MAX_VALUE + 1)), Charsets.UTF_8));
    // TODO (https://github.com/google/guava/issues/5648) the hash expected here is not correct
    assertHash(0x256068c8, murmur3_32()
