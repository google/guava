...
public class MediaTypeTest extends TestCase {
  ...
  public void testCreate_useConstants() throws Exception {
    for (MediaType constant : getConstants()) {
      assertSame(
          constant,
          MediaType.create(constant.type(), constant.subtype()).withParameters(
              constant.parameters()));
    }
  }
  ...
  private static final ImmutableListMultimap<String, String> PARAMETERS = ImmutableListMultimap.of(
      "a", "1", "a", "2", "b", "3");
  ...
  public void testWithoutParameters() {
    ...
    assertEquals(MediaType.parse("image/gif"), MediaType.parse("image/gif; foo=bar")
        .withoutParameters());
  }

  public void testWithParameters() {
    assertEquals(MediaType.parse("text/plain; a=1; a=2; b=3"), MediaType.parse("text/plain")
  ...
  public void testWithParameter() {
    ...
    assertEquals(MediaType.parse("text/plain; a=1"), MediaType.parse("text/plain; a=1; a=2")
        .withParameter("a", "1"));
    assertEquals(MediaType.parse("text/plain; a=3"), MediaType.parse("text/plain; a=1; a=2")
        .withParameter("a", "3"));
    assertEquals(MediaType.parse("text/plain; a=1; a=2; b=3"),
  ...
  public void testWithCharset() {
    assertEquals(MediaType.parse("text/plain; charset=utf-8"), MediaType.parse("text/plain")
        .withCharset(UTF_8));
  ...
  public void testGetCharset() {
    ...
    assertEquals(Optional.of(UTF_8), MediaType.parse("text/plain; charset=utf-8").charset());
  }

  @GwtIncompatible("Non-UTF-8 Charset")
  public void testGetCharset_utf16() {
    assertEquals(Optional.of(UTF_16), MediaType.parse("text/plain; charset=utf-16").charset());
  }
  ...
  public void testEquals() {
    new EqualsTester()
        ...
        .addEqualityGroup(
            MediaType.create("text", "plain").withParameters(
                ImmutableListMultimap.of("a", "1", "a", "2")),
            MediaType.create("text", "plain").withParameters(
                ImmutableListMultimap.of("a", "2", "a", "1")))
