...
public class TypeTokenResolutionTest extends TestCase {
  ...
  // exceptions
  private interface IntegerStringFunction extends IntegerSupplier, Predicate<List<String>>,
      StringListPredicate {
  }
  ...
  public void testGenericInterface() {
    ...
    assertEquals(Integer.class, TypeToken.of(IntegerStringFunction.class).resolveType(fType)
        .getRawType());
  ...
  public void testResolveType() {
    ...
    assertEquals(String.class,
        TypeToken.of(StringIterable.class).resolveType(Iterable.class.getTypeParameters()[0])
            .getType());
    assertEquals(String.class,
        TypeToken.of(StringIterable.class).resolveType(Iterable.class.getTypeParameters()[0])
            .getType());
  ...
  private abstract class WithGenericBound<A> {
    ...
    Type getTargetType(String methodName) throws Exception {
      ParameterizedType parameterType =
          (ParameterizedType) WithGenericBound.class.getDeclaredMethod(methodName, List.class)
  ...
  public void testWithMutualRecursiveBoundInTypeVariable() throws Exception {
    ParameterizedType paramType =
        (ParameterizedType) new WithGenericBound<String>() {}
  ...
  private interface SubTypeOfWithFalseRecursiveType<K1, V1> extends
      WithFalseRecursiveType<List<K1>, List<V1>> {
