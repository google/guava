...
public class ImmutableTypeToInstanceMapTest extends TestCase {
  ...
  public void testPrimitiveAndWrapper() {
    ImmutableTypeToInstanceMap<Number> map =
        ImmutableTypeToInstanceMap.<Number>builder().put(Integer.class, 0).put(int.class, 1)
            .build();
  ...
  abstract static class TestTypeToInstanceMapGenerator implements
      TestMapGenerator<TypeToken, Object> {
