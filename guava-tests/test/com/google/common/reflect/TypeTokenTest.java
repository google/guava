...
public class TypeTokenTest extends TestCase {
  ...
  public void testGetTypes_noSuperclass() {
    ...
    ASSERT.that(types).hasContentsAnyOrder(TypeToken.of(Object.class));
    ASSERT.that(types.rawTypes()).hasContentsAnyOrder(Object.class);
    ASSERT.that(types.interfaces()).isEmpty();
    ASSERT.that(types.interfaces().rawTypes()).isEmpty();
    ASSERT.that(types.classes()).hasContentsAnyOrder(TypeToken.of(Object.class));
    ASSERT.that(types.classes().rawTypes()).hasContentsAnyOrder(Object.class);
  }

  public void testGetTypes_fromInterface() {
    TypeToken<Interface1>.TypeSet types = new TypeToken<Interface1>() {}.getTypes();
    ASSERT.that(types).hasContentsInOrder(TypeToken.of(Interface1.class));
    ASSERT.that(types.rawTypes()).hasContentsInOrder(Interface1.class);
    ASSERT.that(types.interfaces()).hasContentsAnyOrder(TypeToken.of(Interface1.class));
    ASSERT.that(types.interfaces().rawTypes()).hasContentsAnyOrder(Interface1.class);
  ...
  public void testGetTypes_fromPrimitive() {
    ...
    ASSERT.that(types).hasContentsAnyOrder(TypeToken.of(int.class));
    ASSERT.that(types.rawTypes()).hasContentsAnyOrder(int.class);
    ASSERT.that(types.interfaces()).isEmpty();
    ASSERT.that(types.interfaces().rawTypes()).isEmpty();
    ASSERT.that(types.classes()).hasContentsAnyOrder(TypeToken.of(int.class));
    ASSERT.that(types.classes().rawTypes()).hasContentsAnyOrder(int.class);
  }
  ...
  public void testGetTypes_withInterfacesAndSuperclasses() {
    ...
    ASSERT.that(types).hasContentsAnyOrder(
    ...
    ASSERT.that(types.interfaces()).hasContentsAnyOrder(
        new TypeToken<Interface3<String>>() {},
        TypeToken.of(Interface12.class),
        TypeToken.of(Interface1.class),
        TypeToken.of(Interface2.class),
        new TypeToken<Iterable<String>>() {});
    ASSERT.that(types.classes()).hasContentsAnyOrder(
        new TypeToken<Class3<String>>() {},
        TypeToken.of(Class2.class),
        TypeToken.of(Class1.class),
        TypeToken.of(Object.class));
  ...
  public void testGetTypes_rawTypes_withInterfacesAndSuperclasses() {
    ...
    ASSERT.that(types.rawTypes()).hasContentsAnyOrder(
        ...
        Class1.class,
        Object.class);
    ASSERT.that(types.interfaces().rawTypes()).hasContentsAnyOrder(
        Interface3.class,
        Interface12.class,
        Interface1.class,
        Interface2.class,
        Iterable.class);
    ASSERT.that(types.classes().rawTypes()).hasContentsAnyOrder(
        Class3.class,
        Class2.class,
        Class1.class,
        Object.class);
  ...
  void testGetTypes_ignoresTypeVariablesByDefault() {
    ...
    ASSERT.that(types).hasContentsAnyOrder(
        ...
        TypeToken.of(Object.class));
    assertSubtypeFirst(types);
    ASSERT.that(types.interfaces()).hasContentsInOrder(
        TypeToken.of(Interface1.class));
    ASSERT.that(types.classes()).hasContentsInOrder(
  ...
  void testGetTypes_rawTypes_ignoresTypeVariablesByDefault() {
    ...
    ASSERT.that(types.rawTypes()).hasContentsAnyOrder(
        ...
        Object.class);
    ASSERT.that(types.interfaces().rawTypes()).hasContentsInOrder(
        Interface1.class);
    ASSERT.that(types.classes().rawTypes()).hasContentsInOrder(
  ...
  void testGetGenericInterfaces_typeVariable_boundsAreClassWithInterface() {
    ASSERT.that(TypeToken.of(new TypeCapture<T>() {}.capture()).getGenericInterfaces())
        .hasContentsAnyOrder(new TypeToken<Iterable<String>>() {});
    assertHasArrayInterfaces(new TypeToken<T[]>() {});
  }
  ...
  void testGetGenericInterfaces_typeVariable_boundsAreFBoundedInterfaces() {
    ASSERT.that(TypeToken.of(new TypeCapture<T>() {}.capture()).getGenericInterfaces())
        .hasContentsAnyOrder(
            TypeToken.of(CharSequence.class), new TypeToken<Iterable<T>>() {});
    assertHasArrayInterfaces(new TypeToken<T[]>() {});
  }
  ...
  void testGetGenericInterfaces_typeVariable_boundsAreClassWithFBoundedInterface() {
    ASSERT.that(TypeToken.of(new TypeCapture<T>() {}.capture()).getGenericInterfaces())
        .hasContentsAnyOrder(new TypeToken<Iterable<T>>() {});
    assertHasArrayInterfaces(new TypeToken<T[]>() {});
  }
  ...
  void testGetGenericInterfaces_typeVariable_boundIsTypeVariableAndInterface() {
    ASSERT.that(TypeToken.of(new TypeCapture<T2>() {}.capture()).getGenericInterfaces())
        .hasContentsAnyOrder(TypeToken.of(new TypeCapture<T1>() {}.capture()));
    assertHasArrayInterfaces(new TypeToken<T2[]>() {});
  }
  ...
  public void testGetGenericInterfaces_wildcard_boundIsInterface() {
    ...
    ASSERT.that(TypeToken.of(Types.subtypeOf(interfaceType.getType())).getGenericInterfaces())
        .hasContentsAnyOrder(interfaceType);
  ...
  public <T> void testNulls() throws Exception {
