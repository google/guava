...
public class EventBusTest extends TestCase {
  ...
  public void testPolymorphicDistribution() {
    ...
    assertEquals("Comparable fixture must be thirdobject delivered.", compEvent,
        objectEvents.get(2));
    ...
    assertEquals("Comparable fixture must be second comparable delivered.", compEvent,
        compEvents.get(1));
  }
  ...
  public void testUnregister() {
    ...
    assertEquals("One correct event should be delivered.", Lists.newArrayList(EVENT),
        catcher2.getEvents());
   ...
   */
  private static final class RecordingSubscriberExceptionHandler implements
