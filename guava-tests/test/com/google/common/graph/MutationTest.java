...
/**
 * Tests for repeated node and edge addition and removal.
 */
...
public final class MutationTest {
  ...
  public void directedBasicGraph() {
    testBasicGraph(BasicGraphBuilder.directed());
  }

  @Test
  public void undirectedBasicGraph() {
    testBasicGraph(BasicGraphBuilder.undirected());
  }

  private static void testBasicGraph(BasicGraphBuilder<? super Integer> graphBuilder) {
