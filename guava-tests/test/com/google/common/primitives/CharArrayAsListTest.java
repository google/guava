  ...
  public static Test suite() {
    List<ListTestSuiteBuilder<Character>> builders =
        ImmutableList.of(
            ...
            ListTestSuiteBuilder.using(new CharsAsListHeadSubListGenerator()).named(
                "Chars.asList, head subList"),

            ListTestSuiteBuilder.using(new CharsAsListTailSubListGenerator()).named(
                "Chars.asList, tail subList"),

            ListTestSuiteBuilder.using(new CharsAsListMiddleSubListGenerator()).named(
                "Chars.asList, middle subList"));
