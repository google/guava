...
public class BytesTest extends TestCase {
  ...
  public void testIndexOf_arrayTarget() {
    ...
    assertEquals(1, Bytes.indexOf(new byte[] {(byte) 2, (byte) 3, (byte) 3, (byte) 3, (byte) 3},
        new byte[] {(byte) 3}));
    assertEquals(
        2,
        Bytes.indexOf(new byte[] {(byte) 2, (byte) 3, (byte) 2, (byte) 3, (byte) 4, (byte) 2,
            (byte) 3}, new byte[] {(byte) 2, (byte) 3, (byte) 4}));
    assertEquals(
        1,
        Bytes.indexOf(new byte[] {(byte) 2, (byte) 2, (byte) 3, (byte) 4, (byte) 2, (byte) 3,
            (byte) 4}, new byte[] {(byte) 2, (byte) 3, (byte) 4}));
    assertEquals(
        -1,
        Bytes.indexOf(new byte[] {(byte) 4, (byte) 3, (byte) 2}, new byte[] {(byte) 2, (byte) 3,
            (byte) 4}));
  }
  ...
  public void testLastIndexOf() {
    ...
    assertEquals(3,
        Bytes.lastIndexOf(new byte[] {(byte) 2, (byte) 3, (byte) 2, (byte) 3}, (byte) 3));
  }
  ...
  public void testConcat() {
    ...
    assertTrue(Arrays.equals(new byte[] {(byte) 1, (byte) 1, (byte) 1},
        Bytes.concat(ARRAY1, ARRAY1, ARRAY1)));
    assertTrue(Arrays.equals(new byte[] {(byte) 1, (byte) 2, (byte) 3, (byte) 4},
  ...
  public void testEnsureCapacity() {
    ...
    assertTrue(Arrays.equals(new byte[] {(byte) 1, (byte) 0, (byte) 0},
