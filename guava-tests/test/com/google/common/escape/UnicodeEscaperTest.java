...
public class UnicodeEscaperTest extends TestCase {
  ...
  public void testNopEscaper() throws IOException {
    UnicodeEscaper e = NOP_ESCAPER;
    assertEquals(TEST_STRING, escapeAsString(e, TEST_STRING));
  }

  public void testSimpleEscaper() throws IOException {
  ...
  public void testSurrogatePairs() throws IOException {
    ...
    // Put surrogate pairs a odd indices so they can be split easily
    dst[0] = 'x';
