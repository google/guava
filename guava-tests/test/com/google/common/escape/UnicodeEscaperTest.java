...
public class UnicodeEscaperTest extends TestCase {
  ...
  private static final String SMALLEST_SURROGATE = "" + Character.MIN_HIGH_SURROGATE
      + Character.MIN_LOW_SURROGATE;
  private static final String LARGEST_SURROGATE = "" + Character.MAX_HIGH_SURROGATE
  ...
  public void testSimpleEscaper() {
    ...
    String expected =
        "[0]abyz[128][256][2048][4096]ABYZ[65535]" + "[" + Character.MIN_SUPPLEMENTARY_CODE_POINT
  ...
  public void testBadStrings() {
    UnicodeEscaper e = SIMPLE_ESCAPER;
    String[] BAD_STRINGS =
        {String.valueOf(Character.MIN_LOW_SURROGATE), Character.MIN_LOW_SURROGATE + "xyz",
