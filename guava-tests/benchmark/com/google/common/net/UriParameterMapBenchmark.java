...
public class UriParameterMapBenchmark {
  ...
  @Benchmark
  boolean legacyImplRandom(int reps) {
  ...
  @Benchmark
  boolean currentImplRandom(int reps) {
    // Paranoia: acting on hearsay that accessing fields might be slow.
    String[] randomParams = this.randomParams;
    boolean created = false;
    // Allows us to use & instead of %, acting on hearsay that division
  ...
  /**
   * This is an old implementation of {@link UriParameterMap#parse(String, Charset)}, which used
   * {@link Splitter}, String#split(String, int), String#toUpperCase() and String#endsWith(String).
   */
