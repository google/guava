 ...
 * "throw multiple exceptions", or something close to it. The prototypical code that calls for this
...
final class ClusterException extends RuntimeException {
  ...
  private ClusterException(Collection<? extends Throwable> exceptions) {
    super(exceptions.size() + " exceptions were thrown. The first exception is listed as a cause.",
   ...
   * <li>Otherwise, return an instance of {@link ClusterException} that wraps the first exception in
   * the {@code exceptions} collection.
   * </ul>
   *
   * <p>
   * Though this method takes any {@link Collection}, it often makes most sense to pass a
