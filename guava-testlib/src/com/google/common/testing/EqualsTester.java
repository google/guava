 ...
 *
 * <p>
 * To use, create a new EqualsTester and add equality groups where each group contains objects that
 * are supposed to be equal to each other, and objects of different groups are expected to be
 * unequal. For example:
 * 
 * <pre>
 * new EqualsTester().addEqualityGroup(&quot;hello&quot;, &quot;h&quot; + &quot;ello&quot;).addEqualityGroup(&quot;world&quot;, &quot;wor&quot; + &quot;ld&quot;)
 *     .addEqualityGroup(2, 1 + 1).testEquals();
 * </pre>
 * <p>
 * This tests:
 * <ul>
 ...
 * follows:
 * <ul>
 * <li>"{@code [group }<i>i</i>{@code , item }<i>j</i>{@code ]}" refers to the <i>j</i><sup>th</sup>
 * item in the <i>i</i><sup>th</sup> equality group, where both equality groups and the items within
 * equality groups are numbered starting from 1. When either a constructor argument or an equal
 * object is provided, that becomes group 1.
 * </ul>
 *
 * @author Jim McMaster
 * @author Jige Yu
...
public final class EqualsTester {
  ...
  public EqualsTester testEquals() {
    RelationshipTester<Object> delegate =
        new RelationshipTester<Object>(Equivalence.equals(), "Object#equals", "Object#hashCode",
            itemReporter);
  ...
  private void testItems() {
    for (Object item : Iterables.concat(equalityGroups)) {
      ...
      assertEquals("the Object#hashCode of " + item + " must be consistent", item.hashCode(),
          item.hashCode());
    }
  }
