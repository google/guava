 ...
 *
 * <p>
 * To use, create a new {@link EquivalenceTester} and add equivalence groups where each group
 ...
 * {@link EqualsTester}. It includes an extra test against an instance of an arbitrary class without
 * having to explicitly add another equivalence group.
 *
 * @author Gregory Kick
 * @since 10.0
 *
 *        TODO(gak): turn this into a test suite so that each test can fail independently
 */
@Beta
@GwtCompatible
