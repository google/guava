...
public class TestsForListsInJavaUtil {
  ...
  public Test testsForEmptyList() {
    ...
    }).named("emptyList").withFeatures(CollectionFeature.SERIALIZABLE, CollectionSize.ZERO)
        .suppressing(suppressForEmptyList()).createTestSuite();
  }
  ...
  public Test testsForSingletonList() {
    return ListTestSuiteBuilder
        ...
        .withFeatures(CollectionFeature.SERIALIZABLE, CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionSize.ONE).suppressing(suppressForSingletonList()).createTestSuite();
  }
  ...
  public Test testsForArraysAsList() {
    return ListTestSuiteBuilder
        ...
        .suppressing(suppressForArraysAsList()).createTestSuite();
  }
  ...
  public Test testsForArrayList() {
    return ListTestSuiteBuilder
        ...
        .named("ArrayList")
        .withFeatures(ListFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionFeature.FAILS_FAST_ON_CONCURRENT_MODIFICATION, CollectionSize.ANY)
        .suppressing(suppressForArrayList()).createTestSuite();
  }
  ...
  public Test testsForLinkedList() {
    return ListTestSuiteBuilder
        ...
        .withFeatures(ListFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionFeature.FAILS_FAST_ON_CONCURRENT_MODIFICATION, CollectionSize.ANY)
        .suppressing(suppressForLinkedList()).createTestSuite();
  }
  ...
  public Test testsForCopyOnWriteArrayList() {
    return ListTestSuiteBuilder
        ...
        .withFeatures(ListFeature.SUPPORTS_ADD_WITH_INDEX, ListFeature.SUPPORTS_REMOVE_WITH_INDEX,
            ListFeature.SUPPORTS_SET, CollectionFeature.SUPPORTS_ADD,
            CollectionFeature.SUPPORTS_REMOVE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.ALLOWS_NULL_VALUES, CollectionSize.ANY)
        .suppressing(suppressForCopyOnWriteArrayList()).createTestSuite();
  }
  ...
  public Test testsForUnmodifiableList() {
    return ListTestSuiteBuilder
        ...
        .withFeatures(CollectionFeature.SERIALIZABLE, CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionSize.ANY).suppressing(suppressForUnmodifiableList()).createTestSuite();
  }
  ...
  public Test testsForCheckedList() {
    return ListTestSuiteBuilder
        ...
        .withFeatures(ListFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.RESTRICTS_ELEMENTS, CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionSize.ANY).suppressing(suppressForCheckedList()).createTestSuite();
  }
  ...
  public Test testsForAbstractList() {
    return ListTestSuiteBuilder
        ...
        .withFeatures(CollectionFeature.NONE, CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionSize.ANY).suppressing(suppressForAbstractList()).createTestSuite();
  }
  ...
  public Test testsForAbstractSequentialList() {
    return ListTestSuiteBuilder
        ...
        .withFeatures(ListFeature.GENERAL_PURPOSE, CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionSize.ANY).suppressing(suppressForAbstractSequentialList()).createTestSuite();
  }
}
