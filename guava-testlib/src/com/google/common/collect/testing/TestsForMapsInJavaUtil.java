...
public class TestsForMapsInJavaUtil {
  ...
  public Test testsForEmptyMap() {
    ...
    }).named("emptyMap").withFeatures(CollectionFeature.SERIALIZABLE, CollectionSize.ZERO)
        .suppressing(suppressForEmptyMap()).createTestSuite();
  }
  ...
  public Test testsForSingletonMap() {
    return MapTestSuiteBuilder
        ...
        .withFeatures(MapFeature.ALLOWS_NULL_KEYS, MapFeature.ALLOWS_NULL_VALUES,
            MapFeature.ALLOWS_ANY_NULL_QUERIES, CollectionFeature.SERIALIZABLE, CollectionSize.ONE)
        .suppressing(suppressForSingletonMap()).createTestSuite();
  }
  ...
  public Test testsForHashMap() {
    return MapTestSuiteBuilder
        ...
        .withFeatures(MapFeature.GENERAL_PURPOSE, MapFeature.ALLOWS_NULL_KEYS,
            ...
            CollectionSize.ANY).suppressing(suppressForHashMap()).createTestSuite();
  }
  ...
  public Test testsForLinkedHashMap() {
    return MapTestSuiteBuilder
        ...
        .suppressing(suppressForLinkedHashMap()).createTestSuite();
  }
    ...
    return NavigableMapTestSuiteBuilder
        .using(new TestStringSortedMapGenerator() {
          ...
          protected SortedMap<String, String> create(Entry<String, String>[] entries) {
            /*
             * TODO(cpovirk): it would be nice to create an input Map and use the copy constructor
        ...
        .withFeatures(MapFeature.GENERAL_PURPOSE, MapFeature.ALLOWS_NULL_VALUES,
            ...
            CollectionFeature.SUPPORTS_ITERATOR_REMOVE, CollectionFeature.KNOWN_ORDER,
            CollectionFeature.SERIALIZABLE, CollectionSize.ANY)
        .suppressing(suppressForTreeMapNatural()).createTestSuite();
  }
  ...
  public Test testsForTreeMapWithComparator() {
    return NavigableMapTestSuiteBuilder
        ...
        .withFeatures(MapFeature.GENERAL_PURPOSE, MapFeature.ALLOWS_NULL_KEYS,
            ...
            CollectionFeature.SUPPORTS_ITERATOR_REMOVE, CollectionFeature.KNOWN_ORDER,
            CollectionFeature.SERIALIZABLE, CollectionSize.ANY)
        .suppressing(suppressForTreeMapWithComparator()).createTestSuite();
  }
  ...
  public Test testsForEnumMap() {
    return MapTestSuiteBuilder
        ...
        .named("EnumMap")
        .withFeatures(MapFeature.GENERAL_PURPOSE, MapFeature.ALLOWS_NULL_VALUES,
            MapFeature.RESTRICTS_KEYS, CollectionFeature.SUPPORTS_ITERATOR_REMOVE,
            CollectionFeature.KNOWN_ORDER, CollectionFeature.SERIALIZABLE, CollectionSize.ANY)
        .suppressing(suppressForEnumMap()).createTestSuite();
  }
  ...
  public Test testsForConcurrentHashMap() {
    return MapTestSuiteBuilder
        ...
        .withFeatures(MapFeature.GENERAL_PURPOSE, CollectionFeature.SUPPORTS_ITERATOR_REMOVE,
            CollectionFeature.SERIALIZABLE, CollectionSize.ANY)
        .suppressing(suppressForConcurrentHashMap()).createTestSuite();
  }
  ...
  public Test testsForConcurrentSkipListMapNatural() {
    return NavigableMapTestSuiteBuilder
        ...
        .withFeatures(MapFeature.GENERAL_PURPOSE, CollectionFeature.SUPPORTS_ITERATOR_REMOVE,
            CollectionFeature.KNOWN_ORDER, CollectionFeature.SERIALIZABLE, CollectionSize.ANY)
        .suppressing(suppressForConcurrentSkipListMap()).createTestSuite();
  }
