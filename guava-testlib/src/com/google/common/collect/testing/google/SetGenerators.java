...
public class SetGenerators {
  ...
  public static class ImmutableSortedSetExplicitSuperclassComparatorGenerator extends
  ...
  public static class ImmutableSortedSetReversedOrderGenerator extends TestStringSetGenerator {
    ...
    @Override
    protected SortedSet<String> create(String[] elements) {
      return ImmutableSortedSet.<String>reverseOrder().addAll(Arrays.asList(elements).iterator())
          .build();
    }
  ...
  public static class ImmutableSortedSetDescendingAsListGenerator extends TestStringListGenerator {
    ...
    protected List<String> create(String[] elements) {
      ...
      return ImmutableSortedSet.orderedBy(comparator).add(elements).build().descendingSet()
          .asList();
    }
  }
  ...
  public static class ImmutableSortedSetSubsetAsListSubListGenerator extends
    ...
    protected List<String> create(String[] elements) {
      ...
      return builder.build().subSet(BEFORE_FIRST_2, AFTER_LAST_2).asList()
          .subList(1, elements.length + 1);
    }
  }

  public abstract static class TestUnhashableSetGenerator extends
      TestUnhashableCollectionGenerator<Set<UnhashableObject>> implements
      TestSetGenerator<UnhashableObject> {
  }
  ...
  private abstract static class AbstractContiguousSetGenerator extends
