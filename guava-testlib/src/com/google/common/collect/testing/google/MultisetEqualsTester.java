...
public class MultisetEqualsTester<E> extends AbstractMultisetTester<E> {
  public void testEqualsSameContents() {
    new EqualsTester().addEqualityGroup(getMultiset(),
  ...
  public void testEqualsMultisetWithNullValue() {
    new EqualsTester()
        ...
        .addEqualityGroup(getSubjectGenerator().create(createArrayWithNullElement()),
            getSubjectGenerator().create(createArrayWithNullElement())).testEquals();
  }
}
