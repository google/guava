 ...
 */
public class SetMultimapTestSuiteBuilder<K, V> extends
    MultimapTestSuiteBuilder<K, V, SetMultimap<K, V>> {
  ...
  TestSuite computeMultimapAsMapGetTestSuite(
    ...
    if (Collections.disjoint(features, EnumSet.allOf(CollectionSize.class))) {
      ...
      return SetTestSuiteBuilder
          .using(new MultimapAsMapGetGenerator<K, V>(parentBuilder.getSubjectGenerator()))
  ...
  private static class EntriesGenerator<K, V> extends
      MultimapTestSuiteBuilder.EntriesGenerator<K, V, SetMultimap<K, V>> implements
      TestSetGenerator<Entry<K, V>> {
  ...
  static class MultimapGetGenerator<K, V> extends
      MultimapTestSuiteBuilder.MultimapGetGenerator<K, V, SetMultimap<K, V>> implements
      TestSetGenerator<V> {
  ...
  static class MultimapAsMapGetGenerator<K, V> extends
      MultimapTestSuiteBuilder.MultimapAsMapGetGenerator<K, V, SetMultimap<K, V>> implements
      TestSetGenerator<V> {
