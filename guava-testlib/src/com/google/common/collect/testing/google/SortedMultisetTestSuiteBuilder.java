 ...
 *
 * <p>
 * <b>Warning:</b> expects that {@code E} is a String.
 *
...
public class SortedMultisetTestSuiteBuilder<E> extends MultisetTestSuiteBuilder<E> {
  ...
  private TestSuite createSubMultisetSuite(SortedMultisetTestSuiteBuilder<E> parentBuilder,
    ...
    }).named(parentBuilder.getName() + " subMultiset " + from + "-" + to).withFeatures(features)
        .suppressing(parentBuilder.getSuppressedTests()).createTestSuite();
  }
   ...
   *
   * <p>
   * This method (dangerously) assume that the strings {@code "!! a"} and {@code "~~ z"} will work
   * for this purpose, which may cause problems for navigable maps with non-string or unicode
   * generators.
   */
  ...
  private TestSuite createReserializedSuite(SortedMultisetTestSuiteBuilder<E> parentBuilder) {
    ...
    }).named(parentBuilder.getName() + " reserialized").withFeatures(features)
        .suppressing(parentBuilder.getSuppressedTests()).createTestSuite();
  }
