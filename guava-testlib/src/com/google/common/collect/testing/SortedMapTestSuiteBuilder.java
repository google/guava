...
public class SortedMapTestSuiteBuilder<K, V> extends MapTestSuiteBuilder<K, V> {
  ...
  final TestSuite createSubmapSuite(final FeatureSpecificTestSuiteBuilder<?,
    ...
    return newBuilderUsing(new ForwardingTestMapGenerator<K, V>(delegate) {
          @Override public Map<K, V> create(Object... entries) {
            ...
            return createSubMap(map,
                firstInclusive, firstExclusive, lastExclusive, lastInclusive, from, to);
          }
        })
   ...
   * overridden by NavigableMapTestSuiteBuilder.
   */
  SortedMap<K, V> createSubMap(SortedMap<K, V> map,
  ...
  SortedMapTestSuiteBuilder<K, V> newBuilderUsing(TestMapGenerator<K, V> generator) {
