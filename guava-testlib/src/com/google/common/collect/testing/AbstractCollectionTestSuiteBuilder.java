...
public abstract class AbstractCollectionTestSuiteBuilder<B extends AbstractCollectionTestSuiteBuilder<B, E>, E>
  ...
  protected List<Class<? extends AbstractTester>> getTesters() {
    return Arrays.<Class<? extends AbstractTester>>asList(CollectionAddAllTester.class,
        CollectionAddTester.class, CollectionClearTester.class, CollectionContainsAllTester.class,
  ...
  protected List<TestSuite> createDerivedSuites(
    ...
    DerivedIteratorTestSuiteBuilder<?> iteratorTestSuiteBuilder =
        new DerivedIteratorTestSuiteBuilder<E>().named(parentBuilder.getName())
