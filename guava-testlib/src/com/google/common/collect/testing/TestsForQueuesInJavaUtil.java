...
public class TestsForQueuesInJavaUtil {
  ...
  public Test testsForLinkedList() {
    return QueueTestSuiteBuilder
        ...
        .named("LinkedList")
        .withFeatures(CollectionFeature.GENERAL_PURPOSE, CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionFeature.KNOWN_ORDER, CollectionSize.ANY).skipCollectionTests() // already
                                                                                     // covered in
  ...
  public Test testsForArrayBlockingQueue() {
    return QueueTestSuiteBuilder
        ...
        .withFeatures(CollectionFeature.GENERAL_PURPOSE, CollectionFeature.KNOWN_ORDER,
            CollectionSize.ANY).suppressing(suppressForArrayBlockingQueue()).createTestSuite();
  }
  ...
  public Test testsForConcurrentLinkedQueue() {
    return QueueTestSuiteBuilder
        ...
        .withFeatures(CollectionFeature.GENERAL_PURPOSE, CollectionFeature.KNOWN_ORDER,
            CollectionSize.ANY).suppressing(suppressForConcurrentLinkedQueue()).createTestSuite();
  }
  ...
  public Test testsForLinkedBlockingQueue() {
    return QueueTestSuiteBuilder
        ...
        .withFeatures(CollectionFeature.GENERAL_PURPOSE, CollectionFeature.KNOWN_ORDER,
            CollectionSize.ANY).suppressing(suppressForLinkedBlockingQueue()).createTestSuite();
  }
  ...
  public Test testsForPriorityBlockingQueue() {
    return QueueTestSuiteBuilder.using(new TestStringQueueGenerator() {
      ...
      public Queue<String> create(String[] elements) {
        ...
        .suppressing(suppressForPriorityBlockingQueue()).createTestSuite();
  }
  ...
  public Test testsForPriorityQueue() {
    ...
    }).named("PriorityQueue").withFeatures(CollectionFeature.GENERAL_PURPOSE, CollectionSize.ANY)
        .suppressing(suppressForPriorityQueue()).createTestSuite();
  }
}
