...
public class FeatureUtil {
  ...
  private static void checkConflict(String earlierRequirement, Set<Feature<?>> earlierFeatures,
      String newRequirement, Set<Feature<?>> newFeatures, Object source)
      throws ConflictingRequirementsException {
    ...
    if (!conflictingFeatures.isEmpty()) {
      throw new ConflictingRequirementsException(String.format(Locale.ROOT,
          ...
          newRequirement, earlierRequirement), conflictingFeatures, source);
    }
  }
  ...
  /**
   * Construct a new {@link java.util.Set} that is the intersection of all the given sets.
   * 
   * @param sets the sets to intersect
   * @return the intersection of the sets
   * @throws java.lang.IllegalArgumentException if there are no sets to intersect
   */
