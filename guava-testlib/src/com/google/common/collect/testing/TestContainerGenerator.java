...
public interface TestContainerGenerator<T, E> {
   ...
   * {@link com.google.common.collect.testing.features.CollectionFeature#KNOWN_ORDER} is specified
   * when creating the test suite. It should never run when testing containers such as
   * {@link java.util.HashSet}, which have a non-deterministic iteration order.
   */
