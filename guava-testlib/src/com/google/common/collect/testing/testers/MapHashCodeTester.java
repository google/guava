...
public class MapHashCodeTester<K, V> extends AbstractMapTester<K, V> {
  public void testHashCode() {
    ...
    assertEquals("A Map's hashCode() should be the sum of those of its entries.", expectedHashCode,
        getMap().hashCode());
  }
  ...
  private void runEntryWithNullTest(Map.Entry<K, V> entryWithNull) {
    ...
    assertEquals("A Map's hashCode() should be the sum of those of its entries (where "
