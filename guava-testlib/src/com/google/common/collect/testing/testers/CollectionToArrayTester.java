...
public class CollectionToArrayTester<E> extends AbstractCollectionTester<E> {
   ...
   *
   * <p>
   * For maximum effect, the collection under test should be created from an element array of a type
   * other than {@code Object[]}.
   */
  ...
  public void testToArray_emptyArray() {
    ...
    assertEquals("toArray(emptyT[]) should return an array of type T", empty.getClass(),
        array.getClass());
  ...
  public void testToArray_emptyArrayOfObject() {
    ...
    assertEquals("toArray(emptyObject[]) should return an array of type Object", Object[].class,
        array.getClass());
  ...
  public void testToArray_oversizedArray() {
    ...
    for (int i = 0; i < getNumElements(); i++) {
      assertTrue("toArray(overSizedE[]) should contain element " + expectedSubArray[i],
  ...
  public void testToArray_emptyArrayOfWrongTypeForEmptyCollection() {
    WrongType[] array = new WrongType[0];
    assertSame("toArray(sameSizeNotAssignableTo[]) should return the given array", array,
        collection.toArray(array));
  }
   ...
   * of {@link Arrays#asList(Object[])} can suppress it with
