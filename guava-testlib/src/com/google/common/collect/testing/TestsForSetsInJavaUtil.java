...
public class TestsForSetsInJavaUtil {
  ...
  public Test testsForEmptySet() {
    ...
    }).named("emptySet").withFeatures(CollectionFeature.SERIALIZABLE, CollectionSize.ZERO)
        .suppressing(suppressForEmptySet()).createTestSuite();
  }
  ...
  public Test testsForSingletonSet() {
    return SetTestSuiteBuilder
        ...
        .named("singleton")
        .withFeatures(CollectionFeature.SERIALIZABLE, CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionSize.ONE).suppressing(suppressForSingletonSet()).createTestSuite();
  }
  ...
  public Test testsForHashSet() {
    return SetTestSuiteBuilder
        ...
        .named("HashSet")
        .withFeatures(SetFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionFeature.FAILS_FAST_ON_CONCURRENT_MODIFICATION, CollectionSize.ANY)
        .suppressing(suppressForHashSet()).createTestSuite();
  }
  ...
  public Test testsForLinkedHashSet() {
    return SetTestSuiteBuilder
        ...
        .withFeatures(SetFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            ...
            CollectionFeature.FAILS_FAST_ON_CONCURRENT_MODIFICATION, CollectionSize.ANY)
        .suppressing(suppressForLinkedHashSet()).createTestSuite();
  }
    ...
    return SetTestSuiteBuilder
        .using(new TestEnumSetGenerator() {
          ...
          public Set<AnEnum> create(AnEnum[] elements) {
            return (elements.length == 0) ? EnumSet.noneOf(AnEnum.class) : EnumSet
                .copyOf(MinimalCollection.of(elements));
          }
        })
        .named("EnumSet")
        .withFeatures(SetFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.KNOWN_ORDER, CollectionFeature.RESTRICTS_ELEMENTS, CollectionSize.ANY)
        .suppressing(suppressForEnumSet()).createTestSuite();
  }
  ...
  public Test testsForTreeSetNatural() {
    return NavigableSetTestSuiteBuilder
        ...
        .withFeatures(SetFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.KNOWN_ORDER, CollectionFeature.FAILS_FAST_ON_CONCURRENT_MODIFICATION,
            CollectionSize.ANY).suppressing(suppressForTreeSetNatural()).createTestSuite();
  }
  ...
  public Test testsForTreeSetWithComparator() {
    return NavigableSetTestSuiteBuilder
        ...
        .withFeatures(SetFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.ALLOWS_NULL_VALUES, CollectionFeature.KNOWN_ORDER,
            CollectionFeature.FAILS_FAST_ON_CONCURRENT_MODIFICATION, CollectionSize.ANY)
        .suppressing(suppressForTreeSetWithComparator()).createTestSuite();
  }
  ...
  public Test testsForCopyOnWriteArraySet() {
    return SetTestSuiteBuilder
        ...
        .suppressing(suppressForCopyOnWriteArraySet()).createTestSuite();
  }
  ...
  public Test testsForUnmodifiableSet() {
    return SetTestSuiteBuilder
        ...
        .suppressing(suppressForUnmodifiableSet()).createTestSuite();
  }
  ...
  public Test testsForCheckedSet() {
    return SetTestSuiteBuilder
        ...
        .withFeatures(SetFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.ALLOWS_NULL_VALUES, CollectionFeature.RESTRICTS_ELEMENTS,
            CollectionSize.ANY).suppressing(suppressForCheckedSet()).createTestSuite();
  }
  ...
  public Test testsForAbstractSet() {
    return SetTestSuiteBuilder
        ...
        .named("AbstractSet")
        .withFeatures(CollectionFeature.NONE, CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionFeature.KNOWN_ORDER, // in this case, anyway
            CollectionSize.ANY).suppressing(suppressForAbstractSet()).createTestSuite();
  }
  ...
  public Test testsForBadlyCollidingHashSet() {
    return SetTestSuiteBuilder
        ...
        .withFeatures(SetFeature.GENERAL_PURPOSE, CollectionFeature.ALLOWS_NULL_VALUES,
            CollectionSize.SEVERAL).suppressing(suppressForHashSet()).createTestSuite();
  }
  ...
  public Test testsForConcurrentSkipListSetNatural() {
    return SetTestSuiteBuilder
        ...
        .withFeatures(SetFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.KNOWN_ORDER, CollectionSize.ANY)
        .suppressing(suppressForConcurrentSkipListSetNatural()).createTestSuite();
  }
  ...
  public Test testsForConcurrentSkipListSetWithComparator() {
    return SetTestSuiteBuilder
        ...
        .withFeatures(SetFeature.GENERAL_PURPOSE, CollectionFeature.SERIALIZABLE,
            CollectionFeature.KNOWN_ORDER, CollectionSize.ANY)
        .suppressing(suppressForConcurrentSkipListSetWithComparator()).createTestSuite();
  }
