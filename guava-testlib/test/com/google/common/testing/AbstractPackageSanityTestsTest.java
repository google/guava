...
public class AbstractPackageSanityTestsTest extends TestCase {
  ...
  public void testFindClassesToTest_noCorrespondingTestClass() {
    ...
    assertThat(findClassesToTest(ImmutableList.of(Foo.class, Foo2Test.class))).containsExactly(
        Foo.class);
  }
  ...
  public void testFindClassesToTeset_ignoreUnderscores() {
    assertThat(findClassesToTest(ImmutableList.of(Foo.class, Foo_Bar.class))).containsExactly(
        Foo.class, Foo_Bar.class);
  ...
  public void testFindClassesToTest_withCorrespondingTestClass_noTestName() {
    assertThat(findClassesToTest(ImmutableList.of(Foo.class, FooTest.class))).containsExactly(
        Foo.class);
  }
